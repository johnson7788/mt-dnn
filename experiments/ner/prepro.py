...
def main(args):
    ...
    dump_rows(test_data, test_fout, DataFormat.Sequence)
    ...
    dump_rows(pos_train_data, train_fout, DataFormat.Sequence)
    dump_rows(pos_dev_data, dev_fout, DataFormat.Sequence)
    dump_rows(pos_test_data, test_fout, DataFormat.Sequence)
    ...
    dump_rows(chunk_train_data, train_fout, DataFormat.Sequence)
    dump_rows(chunk_dev_data, dev_fout, DataFormat.Sequence)
    dump_rows(chunk_test_data, test_fout, DataFormat.Sequence)
